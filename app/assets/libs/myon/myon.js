    ...
    return {
        renderJson: function(object, tabSize, maxDepth) {
            ...
            function renderJson(object) {
                return '<div class="json"><div class="json-row"><span class="json-line-number">' + (lineNo++) + '</span><span class="json-row-content">' + renderJsonHelper(object, 0, false) + '</span></div></div>';
            };
            ...
            function renderArray(object, depth, fromKey) {
                ...
                render += '<span class="json-square-brackets">[</span></span></div><div class="json-row"><span class="json-line-number">' + (lineNo++) + '</span><span class="json-row-content">';
                for(var i = 0; i < object.length; i++) {
                    ...
                    if(i < object.length - 1) {
                        render += '<span class="json-comma">,</span></span></div><div class="json-row"><span class="json-line-number">' + (lineNo++) + '</span><span class="json-row-content">';
                    } else {
                        render += '</span></div><div class="json-row"><span class="json-line-number">' + (lineNo++) + '</span><span class="json-row-content">';
                    }
                }  
            ...
            function renderObject(object, depth, fromKey) {
                ...
                var prefixCurr = renderPrefix(depth);
                if(!fromKey) render += prefixCurr;
                render += '<span class="json-curly-brackets">{</span></span></div><div class="json-row"><span class="json-line-number">' + (lineNo++) + '</span><span class="json-row-content">';
                for(var i = 0; i < Object.keys(object).length; i++) {
                    var key = Object.keys(object)[i];
                    if(depth == 0) render += '<span id="anchor-' + key + '"></span>';
